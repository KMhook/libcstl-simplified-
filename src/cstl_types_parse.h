...
typedef enum _tagtypetoken
{
    ...
    _TOKEN_KEY_HASH_SET, _TOKEN_KEY_HASH_MAP,
    _TOKEN_KEY_PAIR, //_TOKEN_KEY_STRING,
    ...
    _TOKEN_KEY_MAP_ITERATOR, 
    _TOKEN_KEY_HASH_SET_ITERATOR, _TOKEN_KEY_HASH_MAP_ITERATOR,
   // _TOKEN_KEY_STRING_ITERATOR,
		_TOKEN_KEY_INPUT_ITERATOR, _TOKEN_KEY_OUTPUT_ITERATOR,
